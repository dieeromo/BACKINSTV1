"""
Django settings for backend_IST project.
...
SECRET_KEY = 'django-insecure-&r3h=(puy=u#10ao9zi+i1ses9^$bp6(og-5o3_i+4(3pu2##+'
...
WSGI_APPLICATION = 'backend_IST.wsgi.application'
